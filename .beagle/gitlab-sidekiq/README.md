...
docker build \
  ...
  --tag registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-sidekiq:v14.2.3-amd64 \
  --file ./.beagle/gitlab-sidekiq/Dockerfile ./.beagle/gitlab-sidekiq/

docker push registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-sidekiq:v14.2.3-amd64
...
docker build \
  ...
  --tag registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-sidekiq:v14.2.3-arm64 \
  --file ./.beagle/gitlab-sidekiq/Dockerfile ./.beagle/gitlab-sidekiq/

docker push registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-sidekiq:v14.2.3-arm64
...
docker build \
  ...
  --tag registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-sidekiq:v14.2.3-ppc64le \
  --file ./.beagle/gitlab-sidekiq/Dockerfile ./.beagle/gitlab-sidekiq/

docker push registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-sidekiq:v14.2.3-ppc64le
```
