...
docker build \
  ...
  --tag registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-webservice:v14.2.3-amd64 \
  --file ./.beagle/gitlab-webservice/Dockerfile ./.beagle/gitlab-webservice/

docker push registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-webservice:v14.2.3-amd64
...
docker build \
  ...
  --tag registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-webservice:v14.2.3-arm64 \
  --file ./.beagle/gitlab-webservice/Dockerfile ./.beagle/gitlab-webservice/

docker push registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-webservice:v14.2.3-arm64
...
docker build \
  ...
  --tag registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-webservice:v14.2.3-ppc64le \
  --file ./.beagle/gitlab-webservice/Dockerfile ./.beagle/gitlab-webservice/

docker push registry.cn-qingdao.aliyuncs.com/wod-arm/gitlab-webservice:v14.2.3-ppc64le
```
