ARG BASE=registry.cn-qingdao.aliyuncs.com/wod/ruby:2.7.4-bullseye
...
RUN set -ex \
 ...
 && DEBIAN_FRONTEND=noninteractive apt-get install --no-install-recommends -y \
      ...
      nginx openssh-server postgresql-client-12 redis-tools \
      ...
      libxml2 libxslt1.1 libcurl4 libicu-dev libre2-dev tzdata unzip libimage-exiftool-perl \
      libmagic1 \
